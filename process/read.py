...
class Dataset:
    ...
    def __init__(self, mode='train'):
        self.mode = mode
        if self.mode == 'train':
            self.path = settings.train_dataset_path
        elif self.mode == 'val':
            self.path = settings.val_dataset_path
        else:
            self.path = settings.test_dataset_path
        self.index_path = settings.dataset_index_path
        self.radio =settings.input_shape[1] /settings.input_shape[0]
